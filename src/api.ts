...
export const GetMetaAccessTxIdAddress = (txid: string) => {
  return aggregation.get(`/v2/app/metaAccess/getMetaAccessContentUserAddressByTxId/${txid}`)
}

export const GetNFTRanks = (params: {
  page: number
  pageSize: number
  key: string
}): Promise<GetNFTRanksRes> => {
